...
public:
    ...
    void SetOrderedConnectedKeyFrames(std::vector<KeyFrame*> mvpOrderedConnectedKeyFrames);
    std::vector<KeyFrame*> GetOrderedConnectedKeyFrames();
...
protected:
    ...
    std::map<uint64_t, id_map> mmMapPoints_nId;
    ...
    std::map<uint64_t, int> mConnectedKeyFrameWeights_nId;
    std::vector<KeyFrame*> mvpOrderedConnectedKeyFrames;
    std::map<uint64_t, id_map> mvpOrderedConnectedKeyFrames_nId;
    ...
    std::map<uint64_t, id_map> mmChildrens_nId;
    std::set<KeyFrame*> mspLoopEdges;
    std::map<uint64_t, id_map> mmLoopEdges_nId;
