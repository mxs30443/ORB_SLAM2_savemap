...
template void KeyFrameDatabase::save<portable_binary_oarchive>(portable_binary_oarchive &, const unsigned int) const;
template void KeyFrameDatabase::load<portable_binary_iarchive>(portable_binary_iarchive &, const unsigned int);
